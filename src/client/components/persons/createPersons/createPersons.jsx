...
function CreatePersons(props) {
    ...
    return(
        <div className="create">
            <input type="number" id="id" className="data__input" min="1" placeholder="Person ID" onChange = {idChange} value = {id} autoComplete="off"/>
            ...
            <input type="number" id="age" className="data__input" placeholder="Age" onChange = {ageChange} value = {age} autoComplete="off"/>
        </div>
    );
}
